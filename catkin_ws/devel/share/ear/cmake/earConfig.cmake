...
if("TRUE" STREQUAL "TRUE")
  set(ear_SOURCE_PREFIX /home/vboxuser/SocialRobotEar/catkin_ws/src/ear)
  set(ear_DEVEL_PREFIX /home/vboxuser/SocialRobotEar/catkin_ws/devel)
  set(ear_INSTALL_PREFIX "")
  set(ear_PREFIX ${ear_DEVEL_PREFIX})
else()
  set(ear_SOURCE_PREFIX "")
  set(ear_DEVEL_PREFIX "")
  set(ear_INSTALL_PREFIX /home/vboxuser/SocialRobotEar/catkin_ws/install)
...
if(NOT "/home/vboxuser/SocialRobotEar/catkin_ws/src/ear/include " STREQUAL " ")
  set(ear_INCLUDE_DIRS "")
  set(_include_dirs "/home/vboxuser/SocialRobotEar/catkin_ws/src/ear/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ear' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ear' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vboxuser/SocialRobotEar/catkin_ws/src/ear/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ear_NUM_DUMMY_TARGETS)
      set(ear_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ear::wrapped-linker-option${ear_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ear_NUM_DUMMY_TARGETS "${ear_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ear::wrapped-linker-option${ear_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ear_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vboxuser/SocialRobotEar/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ear_EXPORTED_TARGETS ${${ear_dep}_EXPORTED_TARGETS})
endforeach()
